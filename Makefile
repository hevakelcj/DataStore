#############################################################################
# Makefile for building: DataStore
# Generated by qmake (2.01a) (Qt 4.8.4) on: ?? 4? 23 21:46:52 2013
# Project:  DataStore.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.8.4/bin/qmake -o Makefile DataStore.pro
#############################################################################
...
Makefile: DataStore.pro  /usr/local/Trolltech/Qt-4.8.4/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.8.4/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.8.4/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.8.4/mkspecs/common/gcc-base.conf \
		/usr/local/Trolltech/Qt-4.8.4/mkspecs/common/gcc-base-unix.conf \
		/usr/local/Trolltech/Qt-4.8.4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile DataStore.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/DataStore1.0.0 || $(MKDIR) .tmp/DataStore1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/DataStore1.0.0/ && $(COPY_FILE) --parents datastore.h .tmp/DataStore1.0.0/ && $(COPY_FILE) --parents datastore.cpp main.cpp .tmp/DataStore1.0.0/ && (cd `dirname .tmp/DataStore1.0.0` && $(TAR) DataStore1.0.0.tar DataStore1.0.0 && $(COMPRESS) DataStore1.0.0.tar) && $(MOVE) `dirname .tmp/DataStore1.0.0`/DataStore1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/DataStore1.0.0
